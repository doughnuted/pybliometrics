...
# import pytest # Added for consistency, though not strictly needed by this change

# from pybliometrics.exception import Scopus400Error
# from pybliometrics.sciencedirect import ScienceDirectSearch # Keep this
# from pybliometrics import init # Changed import
# from pybliometrics.utils import make_search_summary # Assuming this is still needed
