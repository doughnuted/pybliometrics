...
# from pybliometrics.sciencedirect import ArticleEntitlement # Keep this
# from pybliometrics import init # Changed import

# init(keys=["DUMMY_KEY"]) # MODIFIED

# ae_1 = ArticleEntitlement(
#     "10.1016/j.reseneeco.2015.06.001", view="FULL", id_type="doi", refresh=30
# )
...
#     assert (
#         ae_1.link
#         == "https://www.sciencedirect.com/science/article/pii/S092876551500038X"
#     )
