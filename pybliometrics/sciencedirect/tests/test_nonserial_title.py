...
# from pybliometrics.sciencedirect import NonserialTitle # Keep this
...
#     assert (
#         nst_3.editors == "Fatos Xhafa, Mohamed A. Tawhid, Pardeep Kumar and Yugal Kumar"
#     )
...
#     assert (
#         nst_1.link_coverimage
#         == "https://api.elsevier.com/content/nonserial/title/isbn/9780128237519?view=coverimage"
#     )
#     assert (
#         nst_2.link_coverimage
#         == "https://api.elsevier.com/content/nonserial/title/isbn/9780128203101?view=coverimage"
#     )
#     assert (
#         nst_3.link_coverimage
#         == "https://api.elsevier.com/content/nonserial/title/isbn/9780128217771?view=coverimage"
#     )
...
#     assert (
#         nst_2.link_homepage
#         == "https://www.sciencedirect.com/science/book/9780128203101"
#     )
#     assert (
#         nst_3.link_homepage
#         == "https://www.sciencedirect.com/science/book/9780128217771"
#     )
...
#     assert (
#         nst_2.link_search
#         == "https://api.elsevier.com/content/nonserial/title/isbn/9780128203101"
#     )
#     assert (
#         nst_3.link_search
#         == "https://api.elsevier.com/content/nonserial/title/isbn/9780128217771"
#     )
...
#     expected_2 = (
#         "Elias Barriga and Ivana Pajic-Lijakovic (ed.). Viscoelasticity and "
#         "Collective Cell Migration. Academic Press. ISBN: 9780128203101"
#     )
#     expected_3 = (
#         "Fatos Xhafa, Mohamed A. Tawhid, Pardeep Kumar and Yugal Kumar (ed.). "
#         "Machine Learning, Big Data, and IoT for Medical Informatics. Academic "
#         "Press. ISBN: 9780128217771"
#     )
