...
# from pybliometrics.scopus import AbstractRetrieval # Keep this
...
# def test_abstract():
#     expected = (
#         "In this paper we propose a Bayesian analysis of seasonal "
...
#     assert ab1.aggregation_type == "Journal"
#     assert ab2.aggregation_type == "Conference Proceeding"
#     assert ab8.aggregation_type is None


# def test_authkeywords():
#     assert ab1.authkeywords is None
#     expected = ["Bayesian analysis", "Seasonality", "Structural breaks", "Unit roots"]
...
#             city="Pittsburgh",
#             postalcode="15213",
#             addresspart="5000 Forbes Avenue",
#             country="United States",
#             auid=7004212771,
#             orcid=None,
#             indexed_name="Kitchin J.R.",
#             surname="Kitchin",
#             given_name="John R.",
#         )
#     ]
...
#     expected = auth(
#         auid=7403019450, indexed_name="Ahn J.K.", surname="Ahn", given_name="J.K."
#     )
#     assert ab9.authorgroup[0] == expected
#     # Test FULL document w. list of collaborations
#     expected = auth(
#         collaboration_id="S0920379618302370-8f4b482a50491834a3f938b012344bfd",
...
#     expected = (
#         "https://www.scopus.com/inward/citedby.uri?partnerID=HzOxMe3b"
...
#     expected = chemical(
#         source="esbd",
#         cas_registry_number="126547-89-5",
...
# def test_confname():
#     expected2 = (
#         "Proceedings of the 1995 34th IEEE Conference on Decision "
#         "and Control. Part 1 (of 4)"
#     )
#     assert ab2.confname == expected2
#     assert ab3.confname is None
#     expected7 = (
#         "20th Symposium on Design, Test, Integration and Packaging "
...
# def test_coverDate():
#     assert ab1.cover_date == "2015-06-05"
#     assert ab8.cover_date is None
...
# def test_endingPage():
#     assert ab1.ending_page == "3899"
#     assert ab8.ending_page is None
...
#         string="German Research Foundation",
#         acronym="DFG",
#         funding_id=["SFB685"],
...
#     e = (
#         "ACKNOWLEDGMENTS. We thank Dieter Blaas for providing ICAM-1–specific "
...
# def test_get_bibtex():
#     e = (
#         "@article{Kaufmann1991FairnessPricing,\n  author = {Patrick J. "
...
# def test_get_latex():
#     e = (
#         "Philip Hans Franses, Henk Hoekh and Richard Paap, \\textit{"
...
# def test_get_html():
#     e = (
#         '<a href="https://www.scopus.com/authid/detail.url?origin=Author'
...
#     assert ab1.issue_identifier == "6"
#     assert ab8.issue_identifier is None
...
#     assert ab5.openaccess_flag is None
#     assert ab6.openaccess_flag is True
#     assert ab7.openaccess_flag is False
#     assert ab8.openaccess_flag is None


# def test_pageRange():
#     assert ab1.page_range == "3894-3899"
#     assert ab8.page_range is None
...
#     assert ab1.publication_name == "ACS Catalysis"
#     assert ab8.publication_name is None
...
#     assert ab2.publisher_address == "Piscataway, NJ, United States"
#     assert ab8.publisher_address is None
...
#     fulltext1 = (
#         "Implementing Reproducible Research; Stodden, V.; Leisch, "
...
#         doi=None,
#         title=None,
#         authors="Stodden, V.; Leisch, F.; Peng, R.D.",
#         authors_auid=None,
...
#         last=None,
#         citedbycount=None,
#         text="Eds. Chapman and Hall/CRC: London.",
#     )
#     expected7 = ref(
#         position="1",
#         id="85050215448",
...
#     expected = (
#         "https://www.scopus.com/inward/record.uri?partnerID=HzOxMe3b&"
#         "scp=84930616647&origin=inward"
#     )
...
#     expected = bank(name="GENBANK", sequence_number="MG272373", type="referenced")
#     assert expected in received
...
#     assert ab1.starting_page == "3894"
#     assert ab8.starting_page is None
...
#     expected = [
#         area(area="Nuclear and High Energy Physics", abbreviation="PHYS", code=3106)
#     ]
...
#     assert ab1.subtype_description == "Review"
#     assert ab2.subtype_description == "Conference Paper"
#     assert ab5.subtype_description == "Book"
#     assert ab6.subtype_description == "Article"
