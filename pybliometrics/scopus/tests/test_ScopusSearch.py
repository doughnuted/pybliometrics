...
# from pybliometrics.scopus import ScopusSearch # Keep this
...
#     expected = doc(
#         eid="2-s2.0-26444452434",
#         doi="10.1016/0014-2921(92)90085-B",
#         pii="001429219290085B",
#         pubmed_id=None,
...
#         author_count="1",
#         author_names="Draghi, Mario",
#         author_ids="24320488600",
#         author_afids=None,
#         coverDate="1992-01-01",
#         coverDisplayDate="April 1992",
#         publicationName="European Economic Review",
#         issn="00142921",
#         source_id="20749",
#         eIssn=None,
...
#     )
#     keywords = (
#         "Extreme-Bounds-Analysis (EBA) | Patent rights protection | "
#         "R&D investment | Technology transfer"
#     )
#     title = (
#         "Determinants of R&D investment: The Extreme-Bounds-"
#         "Analysis approach applied to 26 OECD countries"
#     )
#     expected = doc(
#         eid="2-s2.0-74249121335",
#         doi="10.1016/j.respol.2009.11.010",
#         pii="S0048733309002145",
#         pubmed_id=None,
#         title=title,
#         subtype="ar",
#         subtypeDescription="Article",
...
#         author_count="1",
#         author_names="Wang, Eric C.",
#         author_ids="7403414138",
#         author_afids="60007954",
