...
# from pybliometrics.scopus import SubjectClassifications # Keep this
...
# sub5 = SubjectClassifications(
#     {"description": "Engineering", "detail": "Fluid"}, refresh=30
# )
# # Search by multiple criteria, subset returned fields
# sub6 = SubjectClassifications(
#     {"detail": "Analysis", "description": "Mathematics"},
